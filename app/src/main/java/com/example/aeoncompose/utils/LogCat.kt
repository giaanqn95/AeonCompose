...
object LogCat {
    ...
    private fun d(_msg: String, deepth: Int): Int {
        return if (TextUtils.isEmpty(_msg)) Log.e(LogHusky(deepth, TAG.DEBUG), "LogHusky message parameter is empty!!") else Log.d(LogHusky(deepth, TAG.DEBUG), _msg)
    }
    ...
    private fun i(_msg: String, deepth: Int): Int {
        return if (TextUtils.isEmpty(_msg)) Log.e(LogHusky(deepth, TAG.INFO), "LogHusky message parameter is empty!!") else Log.d(LogHusky(deepth, TAG.INFO), _msg)
    }
    ...
    fun e(_msg: String?, deepth: Int): Int {
        return if (TextUtils.isEmpty(_msg)) Log.e(LogHusky(deepth, TAG.ERROR), "LogHusky message parameter is empty!!") else Log.d(
